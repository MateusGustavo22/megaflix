...
export default function SerieCard({name, poster, id}:Props) {
  ...
  return (
    <div onClick={pushPage} style={poster ? {backgroundImage: `url(${moviePostUrl})`} : {backgroundColor: '#2D2E31'}} className="w-[220px] h-[320px] cursor-pointer relative rounded-xl  border-4 border-primary hover:border-button hover:parent bg-[length:100%_100%]">
