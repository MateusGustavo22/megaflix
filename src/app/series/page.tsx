...
export default async function Series() {
  ...
  const actionSerieUrl = `${process.env.NEXT_PUBLIC_SERIE_GENRE}?api_key=${apiKey}&with_genres=${10759}`
  const crimeSerieUrl = `${process.env.NEXT_PUBLIC_SERIE_GENRE}?api_key=${apiKey}&with_genres=${80}`
